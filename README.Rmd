...
* Authors: [Julia Wrobel](https://julia-wrobel.github.io/), Alexander Bauer, [Erin McDonnell](http://eimcdonnell.com/),
...
This package implements statistical methods for registering exponential family functional data. The basic methods are described in more detail in our [paper](https:/julia-wrobel.github.io/Downloads/registration_ef.pdf) and were further adapted to (potentially) incomplete curve settings where (some) curves
