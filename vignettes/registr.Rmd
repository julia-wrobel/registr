...
template. See for example the following (partly incomplete)
curves, where the shape of the mean curve does not match any of the observed
curve shapes well.
...
reg1 = registr(Y = temp_dat, family = "gaussian", Kh = 4,
               preserve_domain = FALSE, lambda_endpoint = 0)
