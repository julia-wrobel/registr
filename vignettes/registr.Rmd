...
registr_parametric = register_fpca(Y = registration_data, family = "gaussian", Kt = 10, 
...
registr_par_priors = register_fpca(Y = registration_data, family = "gaussian", Kt = 10, 
                                   warping = "piecewise_linear2", gradient = FALSE,
                                   prior_1_x_mean_sd = c(0.2, 1), 
                                   prior_1_y_mean_sd = NULL,
...
registr_par_priors2 = register_fpca(Y = registration_data, family = "gaussian", Kt = 10, 
																		warping = "piecewise_linear2", gradient = FALSE,
																		prior_1_x_mean_sd = c(0.2, 0.1), 
																		prior_1_y_mean_sd = NULL,
																		prior_2_x_mean_sd = c(0.8, 0.1), 
																		prior_2_y_mean_sd = c(0.6, 0.1))
